...
exports.onConnectClient = function (client) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, UserConnexions.onAddUser(client.id)];
            case 1:
                res = _a.sent();
                if (res.ok) {
...
exports.onDisconnectClient = function (client) {
    client.on('disconnect', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, UserConnexions.onDeleteUser(client.id)];
                case 1:
                    res = _a.sent();
                    if (res.ok) {
                        console.log(res.message);
...
exports.onSingInClient = function (client, io) {
    client.on('sigin-client', function (payload) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, UserConnexions.onUpdateUser(client.id, payload.id, payload.userName, payload.nameComplete)];
                case 1:
                    res = _a.sent();
                    if (res.ok) {
                        console.log(res.message);
